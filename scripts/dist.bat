...
REM Empaqueta Breakout en una carpeta portable (breakout\dist)
...
REM 4. Copiar solo los recursos que usa Breakout
copy "resources\fonts\space_invaders.ttf" "%DIST%\resources\fonts\" >nul
copy "resources\sounds\shoot.wav" "%DIST%\resources\sounds\" >nul
copy "resources\sounds\invaderkilled.wav" "%DIST%\resources\sounds\" >nul
